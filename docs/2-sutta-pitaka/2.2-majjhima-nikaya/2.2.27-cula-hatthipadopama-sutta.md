...
The Thai version of the Canon here reads va.lavaabhirathena, which seems to be a mixture of two readings recognized in the PTS Dictionary: va.labhi-rathena, "in a roofed chariot"; and va.lavaa-rathena, "in a chariot drawn by mares."

2.

Vacchayana is Pilotika's clan name.
...
This is a pun. For an explanation, see the next note.
